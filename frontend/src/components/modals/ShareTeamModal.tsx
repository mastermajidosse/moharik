...
import { shareTeam } from "../../utils/share";
...
export default function ShareTeamModal({
  ...
  const socialLinks = [
    {
      link: shareTeam({ target: "facebook", title }),
      label: "Facebook",
      icon: (
    ...
    {
      link: shareTeam({ target: "instagram", title }),
      label: "Instagram",
      icon: (
    ...
    {
      link: shareTeam({ target: "twitter", title }),
      label: "Twitter",
      icon: (
        <svg
    ...
    {
      link: shareTeam({ target: "whatsapp", title }),
      label: "Whatsapp",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
